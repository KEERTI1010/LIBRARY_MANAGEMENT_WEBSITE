  ...
  return (
    <div className=" flex items-center justify-center  mx-44 my-66   bg-blue-100 px-6 py-10 rounded-4xl border-amber-400">
      ...
      <div className="">
        ...
        <div className="bg-white rounded-xl px-4 py-3 text-gray-400"><h1>name@gamil.com</h1></div>
        <h1 className="text-sm font-semibold text-gray-500 mt-4">Password</h1>
        <div className="bg-white rounded-xl px-4 py-3 text-gray-400"><h1>Enter your Password</h1></div>
